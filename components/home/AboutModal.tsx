              ...
              <div className="rounded-lg shadow-xl relative flex flex-col w-full bg-customPink outline-none focus:outline-none text-gray-800 bg-opacity-90">
                ...
                <div className="relative p-6 flex-auto pt-0 text-sm md:text-lg my-4 leading-relaxed">
                  <p>
                    ...
                    festivals/conferences including the Catalytic Sound
                    Festival and TENOR. 
                    </p> I have made software for musical
                    performances, native devices, and the WORLD WIDE WEB. More information can be
                    found on the respective pages about these things. 
                    </p>
